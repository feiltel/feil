...
public class Recycler2Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Recycler2Adapter(Context contexts, ArrayList<Map<String, Object>> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM1) {
            View view = mInflater.inflate(R.layout.recycler2_item1,
                    parent, false);
